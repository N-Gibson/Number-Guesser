// var userMin = document.getElementyById('#lower-range').value;
...
setRange.addEventListener('click', function(){
  if userMin 
    ...
    function generateRandomNumber (0, 100) {
...
generateRandomNumber(userMin, userMax)
...
// generateNumber(userMin, userMax);
...
var updateGame = document.querySelector('.min-max');

updateGame.addEventListener('click', function (){

})

function diasbleButton() {
  ;
